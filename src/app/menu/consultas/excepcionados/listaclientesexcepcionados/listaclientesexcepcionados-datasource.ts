...
export interface ListaclientesexcepcionadosItem {
  tipoCuenta: string;
...
/**
 * Data source for the Listaclientesexcepcionados view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class ListaclientesexcepcionadosDataSource extends DataSource<ListaclientesexcepcionadosItem> {
  data: ListaclientesexcepcionadosItem[];
   ...
   */
  connect(): Observable<ListaclientesexcepcionadosItem[]> {
   ...
   */
  private getPagedData(data: ListaclientesexcepcionadosItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ListaclientesexcepcionadosItem[]) {
