...
export interface ListatransaccionesexcepcionadasItem {
  tipoCuenta: string;
...
/*const EXAMPLE_DATA: ListatransaccionesexcepcionadasItem[] = [
  {
    tipoCuenta: "string",
...
/**
 * Data source for the Listatransaccionesexcepcionadas view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class ListatransaccionesexcepcionadasDataSource extends DataSource<ListatransaccionesexcepcionadasItem> {
  data: ListatransaccionesexcepcionadasItem[] /*= EXAMPLE_DATA*/;
   ...
   */
  connect(): Observable<ListatransaccionesexcepcionadasItem[]> {
   ...
   */
  private getPagedData(data: ListatransaccionesexcepcionadasItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ListatransaccionesexcepcionadasItem[]) {
