...
export interface ListaexcepcionadosItem {
  tipoCuenta: string;
...
/*const EXAMPLE_DATA: ListaexcepcionadosItem[] = [
  {
    tipoCuenta: 'Prueba',
...
/**
 * Data source for the Listaexcepcionados view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class ListaexcepcionadosDataSource extends DataSource<ListaexcepcionadosItem> {
  data: ListaexcepcionadosItem[] /*= EXAMPLE_DATA*/;
   ...
   */
  connect(): Observable<ListaexcepcionadosItem[]> {
   ...
   */
  private getPagedData(data: ListaexcepcionadosItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ListaexcepcionadosItem[]) {
