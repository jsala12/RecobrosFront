...
export interface ExcclienteItem {
...
/**
 * Data source for the Exccliente view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class ExcclienteDataSource extends DataSource<ExcclienteItem> {
  data: ExcclienteItem[];
   ...
   */
  connect(): Observable<ExcclienteItem[]> {
   ...
   */
  private getPagedData(data: ExcclienteItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ExcclienteItem[]) {
