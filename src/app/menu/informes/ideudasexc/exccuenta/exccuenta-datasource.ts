...
export interface ExccuentaItem {
...
/**
 * Data source for the Exccuenta view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class ExccuentaDataSource extends DataSource<ExccuentaItem> {
  data: ExccuentaItem[];
   ...
   */
  connect(): Observable<ExccuentaItem[]> {
   ...
   */
  private getPagedData(data: ExccuentaItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ExccuentaItem[]) {
