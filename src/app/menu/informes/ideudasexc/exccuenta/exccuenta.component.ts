...
import { ExccuentaDataSource, ExccuentaItem } from './exccuenta-datasource';
...
@Component({
  selector: 'app-exccuenta',
  templateUrl: './exccuenta.component.html',
  styleUrls: ['./exccuenta.component.css']
})
export class ExccuentaComponent implements AfterViewInit, OnInit {
  @ViewChild(MatPaginator, {static: false}) paginator: MatPaginator;
  @ViewChild(MatSort, {static: false}) sort: MatSort;
  @ViewChild(MatTable, {static: false}) table: MatTable<ExccuentaItem>;
  dataSource: ExccuentaDataSource;
  ...
  ngOnInit() {    
    ...
    this.dataSource = new ExccuentaDataSource();
    this.dataSource.data= this.datosP;

    /*
    this.recobrosService.findExcCuenta(this.codTransaccion).subscribe(data => {
  ...
  ExportTOExcel()  {
    ...
    /* save to file */
    XLSX.writeFile(wb, 'InformeExcepcionadasCuenta.xlsx');
    this.spinner.hide();
  }
