...
import { ExcproductoDataSource, ExcproductoItem } from './excproducto-datasource';
...
@Component({
  selector: 'app-excproducto',
  templateUrl: './excproducto.component.html',
  styleUrls: ['./excproducto.component.css']
})
export class ExcproductoComponent implements AfterViewInit, OnInit {
  @ViewChild(MatPaginator, {static: false}) paginator: MatPaginator;
  @ViewChild(MatSort, {static: false}) sort: MatSort;
  @ViewChild(MatTable, {static: false}) table: MatTable<ExcproductoItem>;
  dataSource: ExcproductoDataSource;
  ...
  ngOnInit() {
    ...
    this.dataSource = new ExcproductoDataSource();
    this.dataSource.data= this.datosP;
    /*
    this.recobrosService.findExcProducto(this.codTransaccion).subscribe(data => {
  ...
  ExportTOExcel()  {
    ...
    /* save to file */
    XLSX.writeFile(wb, 'InformeExcepcionadasProducto.xlsx');
    this.spinner.hide();
  }
