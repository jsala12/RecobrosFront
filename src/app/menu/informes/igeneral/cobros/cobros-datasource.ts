...
/**
 * Data source for the Cobros view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class CobrosDataSource extends DataSource<CobrosItem> {
  data: CobrosItem[];
   ...
   */
  private getPagedData(data: CobrosItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: CobrosItem[]) {
