...
import { ListadeudasDataSource, ListadeudasItem } from './listadeudas-datasource';
...
@Component({
  selector: 'app-listadeudas',
  templateUrl: './listadeudas.component.html',
  styleUrls: ['./listadeudas.component.css']
})
export class ListadeudasComponent implements AfterViewInit, OnInit {
  @ViewChild(MatPaginator, {static: false}) paginator: MatPaginator;
  @ViewChild(MatSort, {static: false}) sort: MatSort;
  @ViewChild(MatTable, {static: false}) table: MatTable<ListadeudasItem>;
  dataSource: ListadeudasDataSource;
  ...
  ngOnInit() {
    ...
    //-------------------------------------------------------------------------------------------//  
    this.dataSource = new ListadeudasDataSource();
    ...
    this.recobrosService.findDeudasMes('').subscribe(data => {
